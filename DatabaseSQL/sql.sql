...
-- Database: `automotif`
--
CREATE DATABASE IF NOT EXISTS `automotif` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `automotif`;
...
CREATE TABLE `bonus` (
  ...
  `namaBonus` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `bonus` (`id`, `pegawai_id`, `namaBonus`, `created_at`, `updated_at`) VALUES
(1, 2, 'lembur', NULL, NULL),
(2, 2, 'lembur', NULL, NULL),
(3, 3, 'lembur', NULL, NULL),
(4, 4, 'lembur', NULL, NULL),
(5, 3, 'Makan', NULL, NULL),
(6, 5, 'transport', NULL, NULL),
(7, 4, 'makan', NULL, NULL),
(8, 3, 'makan', NULL, NULL),
(9, 2, 'makan', NULL, NULL),
(10, 4, 'lembur', NULL, NULL),
(11, 2, 'transport', NULL, NULL);
...
(7, '2020_01_07_033149_create_pegawais_table', 1),
(8, '2020_01_07_033149_create_pegawai_table', 2),
(9, '2020_01_08_075422_create_bonus_table', 3),
(10, '2020_01_08_081443_create_bonus_table', 4);
...
INSERT INTO `pegawai` (`id`, `name`, `address`, `handphone`, `created_at`, `updated_at`) VALUES
(2, 'yohanes', 'muara karang No 160, jakut', '098172617799', '2020-01-06 17:00:00', '2020-01-13 19:24:39'),
(3, 'Suci Wulandari', 'Dk. Merdeka No. 834, Samarinda 42474, SulTra', '098717271878', NULL, '2020-01-13 19:44:26'),
(4, 'Laksana Surya Pradipta S.IP', 'Jr. Bambu No. 827, Mojokerto 59654, KalBar', '08878127812', NULL, NULL),
(5, 'Nurul Wastuti S.E.', 'Kpg. Casablanca No. 358, Bima 91004, JaTeng', '08671217628', NULL, '2020-01-13 19:44:35'),
(6, 'Warji Adriansyah M.Ak', 'Psr. Bah Jaya No. 795, Pontianak 84564, NTB', '08561299182', NULL, NULL),
(7, 'Karimah Ina Wijayanti', 'Jln. Sutan Syahrir No. 737, Mojokerto 22113, SumSel', '086712762162', NULL, NULL),
(8, 'Oliva Lailasari', 'Jln. Bagas Pati No. 746, Kendari 70764, SumUt', '08762176272', NULL, NULL),
(9, 'Aslijan Dacin Ramadan', 'Jln. Pattimura No. 281, Subulussalam 26502, Bali', '08561265121', NULL, NULL),
(10, 'Hana Mardhiyah', 'Ds. Banda No. 134, Depok 88846, SulTeng', '08988723126', NULL, NULL),
(11, 'Tira Handayani', 'Ds. Pattimura No. 41, Bau-Bau 33326, Maluku', '081319298182', NULL, NULL),
(12, 'Rina Rini Hartati', 'Ds. Peta No. 173, Padangsidempuan 40110, SulTeng', '082283192831', NULL, NULL);
...
(1, 'krisman', 'krisman@yahoo.com', NULL, '$2y$10$c8/9ZHrHWbjrI8NZagDlquoXUGBK6l7UE4fPgF7/yief2KVy16W9S', NULL, '2020-01-13 19:49:33', '2020-01-13 19:49:33');
...
-- Database: `mlm`
--
CREATE DATABASE IF NOT EXISTS `mlm` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `mlm`;
...
--
ALTER TABLE `transaksi`
  MODIFY `id_transaksi` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;

--
-- AUTO_INCREMENT for table `transaksi_detail`
--
ALTER TABLE `transaksi_detail`
  MODIFY `id_transaksi_detail` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
('root', '[{\"db\":\"mlm\",\"table\":\"transaksi_produk\"},{\"db\":\"mlm\",\"table\":\"transaksi_detail\"},{\"db\":\"mlm\",\"table\":\"transaksi\"},{\"db\":\"mlm\",\"table\":\"anggota\"},{\"db\":\"mlm\",\"table\":\"materi\"},{\"db\":\"mlm\",\"table\":\"komisi\"},{\"db\":\"mlm\",\"table\":\"komisi_template\"},{\"db\":\"mlm\",\"table\":\"tanggal_produk\"},{\"db\":\"mlm\",\"table\":\"produk\"},{\"db\":\"mlm\",\"table\":\"sub_produk\"}]');
...
('root', '2020-03-19 03:15:14', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":245}');
