...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 14, 2020 at 11:39 AM
...
INSERT INTO `anggota` (`id`, `id_anggota`, `id_parent`, `id_jabatan`, `parent_all`, `nama`, `email`, `alamat`, `no_handphone`, `password`, `saldo`, `status`, `no_ktp`, `file_ktp`, `no_npwp`, `created_at`, `updated_at`) VALUES
