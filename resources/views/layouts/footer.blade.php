...
<script src="{{url('adminlte/bower_components/jquery/dist/jquery-3.js')}}"></script>
<script src="{{url('adminlte/bower_components/jquery/dist/jquery.datatable.min.js')}}"></script>
<link rel="stylesheet" href="{{url('adminlte/bower_components/bootstrap/dist/css/bootstrap-datatable.min.js')}}">
<!-- jQuery UI 1.11.4 -->
