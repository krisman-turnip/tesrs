...
<nav class="navbar navbar-default">
	<div class="container-fluid">
      ...
      <div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
				<li><img src="img_login/sidoarjo.png" class="user-image" width= "50px" height= "50px" alt="User Image"><span class=""></span>Nafa Urbach/Admin Ballloney </li>
			</ul>
			<ul class="nav navbar-nav navbar-right">
				<li><span class=""></span> Keluar</a></li>
			</ul>
      </div>
		</div><!-- /.navbar-collapse -->
	</div>
