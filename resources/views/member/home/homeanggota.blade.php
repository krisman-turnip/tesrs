  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active"> 
        <img  src="{{ url('/image_dash/a.jpg') }}" alt="Los Angeles" style="width:1000px;">
      ...
      <div class="item">
        <img  src="{{ url('/image_dash/b.jpg') }}" alt="Chicago" style="width:1000px;">
      </div>
    
      <div class="item">
        <img  src="{{ url('/image_dash/c.jpg') }}" alt="New york" style="width:1000px;">
      </div>
    </div>
