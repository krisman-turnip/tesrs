  ...
  <div class="content-wrapper">
    ...
    <div class="container">
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <a href="{{ url('lihatrequestkomisi') }}" class="btn btn-primary">Kembali</a>
                    <!-- <a href="../pegawai" class="btn btn-primary">store</a> -->
                    <br/>
                    <br/>
                
                    <form method="POST" action="{{url('updaterequestkomisi/'.(isset($anggota) ? $anggota->id_requestkomisi : '')) }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="request" type="text" class="form-control" name="requestkomisi" value="{{$anggota->jumlah_request}}" >
                            </div>
                        </div>
