                        ...
                        <div class="box">
                            <div class="box-body">
                                <form method="POST" action="{{url('user/update')}}">
                                    ...
                                    <input id="email" type="hidden" class="form-control" name="fullname" required value="{{ $user->user_id}}">
                                    <div class="form-group row">
                                        <label for="email" class="col-md-4 col-form-label text-md-right">Full Name</label>

                                        <div class="col-md-6">
                                            <input id="email" type="text" class="form-control" name="fullname" required value="{{ $user->fullname}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" value="{{ $user->password}}" name="password" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="password" type="karyawan_id" class="form-control @error('password') is-invalid @enderror" name="karyawan_id" value="{{ $user->karyawan_id}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="menu" type="text" class="form-control @error('password') is-invalid @enderror" name="menu" value="{{ $user->menu}}" >
